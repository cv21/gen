// File generated by gen (mock). DO NOT EDIT.
package generated
...
func (_m *StringServiceMock) Prefix(x stringsvc.ListOfStrings) *stringsvc.ListOfStrings {
	ret := _m.Called(x)
...
func (_m *StringServiceMock) Yay() io.Reader {
	ret := _m.Called()
